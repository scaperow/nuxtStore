<template>
    <div class=" flex h-full w-full flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 h-screen w-screen">
        <div class="w-96 flex flex-col flex-auto justify-center items-center">
            <div class="mb-5"><svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg"
                    role="img">
            ...
            <div class="flex flex-row gap-3"><button class="btn relative btn-primary" as="button">
                ...
                <!-- <button class="btn relative btn-primary" as="button">
                    <div class="flex w-full gap-2 items-center justify-center">注册</div>
                </button> -->
            </div>
        </div>
    </div>
